    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="max-w-screen-2xl mx-auto px-5 sm:px-6 lg:px-4 py-8"> {/* Reduced py here */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8"> {/* Reduced gap here */}
          {/* Plano Básico */}
          <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col justify-between border-t-8 border-blue-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"> {/* Reduced p here (from p-10 to p-6) */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Básico</h2> {/* Reduced text size and mb */}
              <p className="text-gray-600 mb-4 text-base">Ideal para pequenas empresas e startups que buscam organização inicial.</p> {/* Reduced text size and mb */}
              <p className="text-4xl font-extrabold text-blue-600 mb-6">R$99<span className="text-xl font-medium text-gray-500">/mês</span></p> {/* Reduced text size and mb */}
              <ul className="space-y-3 text-gray-700 mb-8 text-base"> {/* Reduced space-y and mb */}
          ...
          {/* Plano Profissional */}
          <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col justify-between border-t-8 border-green-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 relative"> {/* Reduced p */}
            ...
            <div>
              ...
              <p className="text-4xl font-extrabold text-green-600 mb-6">R$299<span className="text-xl font-medium text-gray-500">/mês</span></p>
          ...
          {/* Plano Empresarial */}
          <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col justify-between border-t-8 border-purple-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"> {/* Reduced p */}
            <div>
              ...
              <p className="text-4xl font-extrabold text-purple-600 mb-6">R$799<span className="text-xl font-medium text-gray-500">/mês</span></p>
              <ul className="space-y-3 text-gray-700 mb-8 text-base">
          ...
          {/* Novo Plano: Ultimate */}
          <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col justify-between border-t-8 border-red-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"> {/* Reduced p */}
            <div>
              ...
              <p className="text-4xl font-extrabold text-red-600 mb-6">R$1499<span className="text-xl font-medium text-gray-500">/mês</span></p>
              <ul className="space-y-3 text-gray-700 mb-8 text-base">
