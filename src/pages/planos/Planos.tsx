    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="max-w-screen-2xl mx-auto px-5 sm:px-6 lg:px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {/* Plano Básico */}
          <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col justify-between border-t-8 border-blue-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Básico</h2>
              <p className="text-gray-600 mb-4 text-base">Ideal para pequenas empresas e startups que buscam organização inicial.</p>
              
              <div className="mb-6">
                <p className="text-4xl font-extrabold text-blue-600">
                  R${getCurrentPrice('basico').price.toLocaleString('pt-BR')}
                  <span className="text-xl font-medium text-gray-500">{getCurrentPrice('basico').period}</span>
                </p>
                {isAnnual && (
                  <div className="mt-2">
              ...
              <ul className="space-y-3 text-gray-700 mb-8 text-base">
                <li className="flex items-center"><CheckCircle size={20} className="text-green-500 mr-2" />Gestão de até 50 clientes ativos</li>
            ...
            <button className="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold text-lg hover:bg-blue-700 transition-colors duration-300">
              Escolher Plano Básico
            </button>
          </div>

          {/* Plano Profissional */}
          <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col justify-between border-t-8 border-green-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 relative">
            <div className="absolute top-0 right-0 -mt-3 -mr-3 bg-green-500 text-white text-xs font-bold px-3 py-1 rounded-full uppercase rotate-3">Mais Popular</div>
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Profissional</h2>
              <p className="text-gray-600 mb-4 text-base">Para empresas em crescimento que precisam de mais recursos e automação.</p>
              
              <div className="mb-6">
                <p className="text-4xl font-extrabold text-green-600">
                  R${getCurrentPrice('profissional').price.toLocaleString('pt-BR')}
                  <span className="text-xl font-medium text-gray-500">{getCurrentPrice('profissional').period}</span>
                </p>
                {isAnnual && (
                  <div className="mt-2">
                    <p className="text-sm text-gray-600">
          ...
          {/* Plano Empresarial */}
          <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col justify-between border-t-8 border-purple-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Empresarial</h2>
              <p className="text-gray-600 mb-4 text-base">Solução completa para grandes equipes e corporações com necessidades complexas.</p>
              
              <div className="mb-6">
                <p className="text-4xl font-extrabold text-purple-600">
                  R${getCurrentPrice('empresarial').price.toLocaleString('pt-BR')}
                  <span className="text-xl font-medium text-gray-500">{getCurrentPrice('empresarial').period}</span>
                </p>
                {isAnnual && (
                  <div className="mt-2">
                    <p className="text-sm text-gray-600">
          ...
          {/* Plano Ultimate */}
          <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col justify-between border-t-8 border-red-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Ultimate</h2>
              <p className="text-gray-600 mb-4 text-base">A solução mais completa para grandes corporações e necessidades específicas.</p>
              
              <div className="mb-6">
                <p className="text-4xl font-extrabold text-red-600">
                  R${getCurrentPrice('ultimate').price.toLocaleString('pt-BR')}
                  <span className="text-xl font-medium text-gray-500">{getCurrentPrice('ultimate').period}</span>
                </p>
                {isAnnual && (
                  <div className="mt-2">
                    <p className="text-sm text-gray-600">
